...
use bevy::{ecs::{archetype::ArchetypeComponentId, query::ComponentAccessKind}, platform::collections::HashMap, prelude::*, render::render_graph::{self, RenderGraph}};
...
pub fn setup(app: &App){
    ...
    for a in schedule.systems().unwrap(){
        let access = if let Ok(access) = a.1.archetype_component_access().try_iter_component_access(){
