...
impl EditorWindow for DebugSettingsWindow {
    ...
    fn ui(&self, world: &mut bevy::prelude::World, _cx: EditorWindowContext, ui: &mut egui::Ui) {
    ...
    fn build(&self, app: &mut App) {
        ...
        if !app.is_plugin_added::<PhysicsDebugPlugin>() {
            ...
            app.insert_gizmo_config(
                ...
                GizmoConfig {
                    enabled: true,
                    render_layers: RenderLayers::layer(EDITOR_RENDER_LAYER),
                    ..default()
                },
            );
        }
...
fn debug_ui_options(
    ...
    Grid::new("debug settings").show(ui, |ui| {
        ...
        if ui
            .checkbox(&mut state.physics_gizmos, "^ in game")
            .changed()
        {
