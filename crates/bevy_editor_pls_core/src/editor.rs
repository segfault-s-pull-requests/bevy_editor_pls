...
pub const EGUI_EDITOR_RENDERTIME: DiagnosticPath =
    DiagnosticPath::const_new("egui_editor_rendertime");
...
impl Editor {
    ...
    fn editor_ui(
        ...
        state
            .get(&world)
            .add_measurement(&EGUI_EDITOR_RENDERTIME, || time);
        state.apply(world);
        // dbg!(time);
    }
...
impl egui_dock::TabViewer for TabViewer<'_> {
    ...
    fn ui(&mut self, ui: &mut egui::Ui, tab: &mut Self::Tab) {
        ...
        let focused = self
            ...
            .state
            .find_active_focused()
            .is_some_and(|f| f.1.entity == tab.entity);
